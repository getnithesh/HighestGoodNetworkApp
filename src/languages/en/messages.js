...
export const THIS_PROJECT_NAME_IS_ALREADY_TAKEN =
...
export const USER_DELETE_CONFIRMATION_FIRST_LINE =
...
export const USER_DELETE_DATA_FOREVER =
  "Understood, C-ya! Delete their Data Forever";
export const USER_DELETE_DATA_INACTIVE =
  "Oops, My Bad! Just Make Them Inactive";
export const USER_DELETE_DATA_ARCHIVE =
  "Wait, Save the Data! Data Archiving is Cool";
